describe('Dialog Test', () => {
    ...
    it('Should click on the button', () => {
        ...
        cy.get('ngx-dialog-name-prompt nb-card-body input').should('exist');
        cy.get('ngx-dialog-name-prompt nb-card-footer button').contains("Submit").should('exist');
        cy.get('ngx-dialog-name-prompt nb-card-footer button').contains("Cancel").should('exist');
    });
    });
